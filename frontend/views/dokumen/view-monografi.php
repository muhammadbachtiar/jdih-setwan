...
<section>
    <br><br><br>
    <div class="container">
        <h1>Monografi Detail</h1><br>
        <div class="text-center">
             <!-- = Html::a('Home', ['/']); ?></p> -->
            <!-- = Html::a('Monografi', ['/dokumen/monografi']); ?></p> -->
            <!-- <p>
                    ...
                    <div class="content">
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-6 col-md-6 mb-3">
                                Nomor Panggil<br>
                                <span class="text-extra-dark-gray font-weight-600"><?= htmlentities($model->nomor_panggil); ?></span>
                            </div>

                            <div class="col-lg-6 col-md-6 mb-3">
                                Penerbit <br>
                                <span class="text-extra-dark-gray font-weight-600"><?= htmlentities($model->penerbit); ?></span>
                            </div>
                            <div class="col-lg-6 col-md-6 mb-3">
                                Tahun Terbit<br>
                            ...
                            <div class="col-lg-6 col-md-6 mb-3">
                                Deskripsi Fisik<br>
                                <span class="text-extra-dark-gray font-weight-600"><?= htmlentities($model->deskripsi_fisik); ?></span>
                            </div>

                            <div class="col-lg-6 col-md-6 mb-3">
                                Klasifikasi<br>
                                <span class="text-extra-dark-gray font-weight-600"><?= htmlentities($model->klasifikasi); ?></span>
                            </div>
                           ...
                           <div class="col-lg-6 col-md-6 mb-3">
                                ISBN<br>
                                <span class="text-extra-dark-gray font-weight-600"><?= htmlentities($model->isbn); ?></span>
                            </div>
                           <div class="col-lg-6 col-md-6 mb-3">
                                Tempat Terbit<br>
                           ...
                           <div class="col-lg-6 col-md-6 mb-3">
                                Anotasi<br>
                                <span class="text-extra-dark-gray font-weight-600"><p class="text-justify"><?= htmlentities($model->sumber); ?></p></span>
                            </div>
                           <div class="col-lg-6 col-md-6 mb-3">
                                Bidang Hukum<br>
                                ...
                                <table class="table">
                                    ...
                                    if (!empty($eksemplar)) {
                                        ...
                                        foreach ($eksemplar as  $data) {
                                            ...
                                            echo '<tr><td>' . htmlentities($data->kode_eksemplar) . '</td>';
                                            echo '<td>' . htmlentities($data->lokasi_rak) . '</td>';
                        if ($data->status_eksemplar =='Dipinjam'){

                                            echo '<td><span class="label label-danger">' . htmlentities($data->status_eksemplar) . '</span></td></tr>';
}else{
 echo '<td>' . htmlentities($data->status_eksemplar) . '</td></tr>';
}
