...
class PeraturanSearch extends Peraturan
{
    ...
    {
        return [
            [['id', 'tipe_dokumen', 'daerah', 'hit_see', 'hit_download', 'is_publish', 'dokumen_type_id'], 'integer'],
    ...
    {
        $query = Peraturan::find()->where(['tipe_dokumen' => 1]);
        ...
        $query->andFilterWhere([
            ...
            'jenis_peraturan' => $this->jenis_peraturan,
