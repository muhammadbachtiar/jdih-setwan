...
/* @var $searchModel backend\models\PolaEksemplarSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Pola Eksemplar';
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Pola Eksemplar' . '</h3>',
        ],
        'toolbar' =>  [
