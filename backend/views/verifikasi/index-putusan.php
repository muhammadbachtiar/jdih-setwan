                ...
                'buttons' => [
                    ...
                    'action' => function ($url, $model) {
                        if ($model->is_publish == 1) {
                            ...
                            return Html::a('<span class="fa fa-check-square"></span>', ['inactive', 'id' => $model->id, 'tahun'=>$model->tahun_terbit], ['title' => 'Batalkan Verikasi', 'class' => 'btn btn-success btn-sm user-active', 'data' => ['confirm' => 'Yakin membatalkan verifikasi ?', 'method' => 'post', 'data-pjax' => false],]);
                        } else {
                            ...
                            return Html::a('<span class="fa fa-ban"></span>', ['active', 'id' => $model->id, 'tahun'=>$model->tahun_terbit], ['title' => 'verifikasi/Publish Produk Hukum', 'class' => 'btn btn-success btn-sm user-inactive', 'data' => ['confirm' => 'Yakin ingin memverifikasi ?', 'method' => 'post', 'data-pjax' => false],]);
                        }
                    },
                ],
            ],
