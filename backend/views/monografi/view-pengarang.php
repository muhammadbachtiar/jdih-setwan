...
$this->title = 'Data Pengarang : ' . $nama;
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Produk Hukum' . '</h3>',
        ],
        'toolbar' =>  [
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($data) {
                    ...
                    return Html::a(strtoupper($data->id_dokumen), ['view', 'id' => $data->id_dokumen]);
                }
            ],
