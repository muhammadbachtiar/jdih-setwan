...
/* @var $searchModel backend\models\TipeKataKunciSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tipe Kata Kunci';
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Tipe Kata Kunci' . '</h3>',
        ],
        'toolbar' =>  [
