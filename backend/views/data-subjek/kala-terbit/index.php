...
/* @var $searchModel backend\models\KalaTerbitSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Kala Terbit';
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Kala Terbit' . '</h3>',
        ],
        'toolbar' =>  [
