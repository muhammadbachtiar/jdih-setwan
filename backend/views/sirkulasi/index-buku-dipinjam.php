...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data Buku Belum Kembali</h3>',
        ],
        'toolbar' =>  [
            [
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($data) {
                    return $data->getPinjam($data->status_peminjaman);
                }
            ],
            // [
            //     'attribute' => 'denda',
