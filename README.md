...
This repository includes a Docker setup that runs the application using PHP 7.4 (php-fpm), nginx, and MySQL 5.7.
...
Database defaults:
- MySQL service `db` (image: mysql:5.7)
- Database: `ildis_v4`, User: `dev` / Password: `dev`

Files added: `docker/`, `docker-compose.yml`, `README.DOCKER.md` (detailed instructions).